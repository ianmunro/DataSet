---
title: "Anime: What Makes a Series Highly Rated?"
author: "Ian Mogensen"
date: "May 8, 2021"
output:
...
library(readr)
anime_data <- read_csv("https://raw.githubusercontent.com/ianmunro/DataSet/main/animes.csv", 
    trim_ws = FALSE)
```
...
Original data set taken from https://www.kaggle.com/dhananjaypahuja/animez?select=animes.csv
Credit to: Dhananjay Pahuja for data set

Code/Rmd file used to analyze the data set uploaded to my Github: https://github.com/ianmunro/DataSet/blob/main/TermProj.Rmd
